...
import { deleteDonationRequestAsAdmin } from "@/lib/actions/donationRequest";
import { AlertDialog, Button } from "@heroui/react";
import toast from "react-hot-toast";


export function AdminDeleteDonationModal({ donation, onDeleted }) {
  ...
  const handleDelete = async () => {
    ...
    const result = await deleteDonationRequestAsAdmin(id);
          ...
          <AlertDialog.Dialog className="sm:max-w-100">
            ...
            <AlertDialog.Body>
              <p>
                ...
                <strong>
                  {donation?.recipientName || "this recipient"}
                </strong>
